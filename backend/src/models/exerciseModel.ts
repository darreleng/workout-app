...
export async function createExercise(userId: string, workoutId: string, exerciseData: ExerciseInput, client?: any) {
...
export async function updateExercise(userId: string, exerciseId: string, exerciseData: ExerciseInput) {
    const { name, sets, reps, weight_kg, rest_seconds } = exerciseData;
